...
namespace Vezir
{
    public partial class Folyokivet : Szulogyerekvaltozasok
    {
        ...
        public Folyokivet(FakUserInterface fak, VezerloControl hivo, Vezerloinfo aktivvezerles)
        {
            InitializeComponent();
            ...
            mozgasinfo.TablaColumns["KOLTSCSOP_ID"].ReadOnly = true;
            mozgasinfo.TablaColumns["KOLTSCSOP_ID"].Lathato = false;
