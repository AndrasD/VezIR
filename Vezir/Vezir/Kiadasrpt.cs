...
namespace Vezir {
    ...
    public class Kiadasrpt : ReportClass {
    ...
    public class CachedKiadasrpt : Component, ICachedReport {
        
        public CachedKiadasrpt() {
        }
